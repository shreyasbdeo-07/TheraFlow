...
const FeatureCard = ({ icon: Icon, title, description, badge }) => (
  <div className="group relative bg-slate-900/40 backdrop-blur-xl border border-white/5 p-5 md:p-8 rounded-[2rem] md:rounded-[2.5rem] hover:bg-slate-800/60 transition-all duration-500 overflow-hidden">
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0b1326] text-slate-200 font-sans selection:bg-teal-500/30 overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-[100] bg-[#0b1326]/50 backdrop-blur-xl border-b border-white/5">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-[#0b1326]/98 backdrop-blur-xl border-t border-white/5 px-6 py-5 space-y-1">
            <Link href="#features" onClick={() => setIsMenuOpen(false)} className="flex items-center py-3 text-slate-300 hover:text-teal-400 font-medium text-sm border-b border-white/5 transition-colors">Features</Link>
            <Link href="#method" onClick={() => setIsMenuOpen(false)} className="flex items-center py-3 text-slate-300 hover:text-teal-400 font-medium text-sm border-b border-white/5 transition-colors">Method</Link>
            ...
            <div className="pt-3 flex flex-col gap-3">
              ...
              <Link href="/signup" onClick={() => setIsMenuOpen(false)} className="w-full text-center py-3 rounded-2xl bg-teal-400 text-slate-950 font-bold text-sm hover:bg-teal-300 transition-all shadow-lg shadow-teal-500/20">Sign Up Free</Link>
            </div>
          </div>
        )}
      </nav>
      ...
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-40 pb-16 sm:pb-24 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
         
          
          <h1 className="text-4xl sm:text-5xl md:text-8xl font-bold text-white leading-[1.1] tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link href="/signup" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 font-bold py-4 sm:py-5 px-8 sm:px-12 rounded-2xl transition-all active:scale-[0.98] bg-teal-400 text-slate-950 hover:bg-teal-300 shadow-2xl shadow-teal-500/40 text-base sm:text-lg">
              Start Your Journey
            </Link>
            <Link href="/about" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 font-bold py-4 sm:py-5 px-8 sm:px-12 rounded-2xl transition-all active:scale-[0.98] bg-slate-800/50 text-white border border-white/10 hover:bg-slate-700/50 backdrop-blur-md text-base sm:text-lg">
              Explore Method
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto space-y-12 md:space-y-20">
          <div className="flex flex-col md:flex-row justify-between items-end gap-6 md:gap-8">
            <div className="space-y-4 max-w-xl">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold text-white tracking-tight">Personalized Wellness</h2>
            </div>
      ...
      {/* Social Proof / Quote */}
      <section className="py-16 md:py-32 px-4 sm:px-6 border-y border-white/5 bg-slate-950/20">
        <div className="max-w-4xl mx-auto text-center space-y-8 md:space-y-12">
          <div className="text-teal-500/20">
            <MessageSquare size={64} fill="currentColor" className="mx-auto" />
          </div>
          <blockquote className="text-2xl sm:text-3xl md:text-5xl font-medium text-white italic leading-tight tracking-tight">
            &ldquo;TheraFlow didn&apos;t just track my mood; it helped me <span className="text-teal-400">understand the rhythm</span> of my soul and provided tools I didn&apos;t know I needed.&rdquo;
          </blockquote>
      ...
      <section className="py-20 md:py-40 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto bg-slate-900/60 backdrop-blur-3xl border border-white/10 rounded-[2rem] sm:rounded-[4rem] p-6 sm:p-12 md:p-24 text-center space-y-8 md:space-y-12 shadow-2xl relative z-10">
          <h2 className="text-3xl sm:text-4xl md:text-7xl font-bold text-white tracking-tight leading-[1.1]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            <Link href="/signup" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 font-bold py-4 sm:py-6 px-10 sm:px-16 rounded-2xl transition-all active:scale-[0.98] bg-teal-400 text-slate-950 hover:bg-teal-300 shadow-lg shadow-teal-500/20 text-base sm:text-xl group">
